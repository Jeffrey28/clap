...
class MainDecision(object):
    ...
    def update_trajectory(self):
        ...
        #TODO: change to always use RL in the junction, close the idm lane utility
        if 0: #dynamic_map.model == dynamic_map.MODEL_MULTILANE_MAP or len(dynamic_boundary.boundary) == 0:
